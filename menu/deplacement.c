...
void deplacement(Joueur*j, Proprietes prop[31])
{
    ...
    for(i = 0; i <32; i++)
    {
        ...
        {
            /// Affichage du nom du joueur sur la case correspondante du plateau
            if (j->position == 0)
            {
                gotoligcol(35,144);
                printf("%s", j->pion);
            ...
            if ((j->position != 2)||(j->position != 6)||(j->position != 10)||(j->position != 14)||(j->position != 18)||(j->position != 22)||(j->position != 26)||(j->position != 30))
            {
            ...
            else if ((j->position == 2)||(j->position == 14)||(j->position == 22)||(j->position == 30))
            {
                etoile(j);
            }
